  ...
  <div class="container">
    <div class="row">
        ...
        <div class="card-body">
          ...
          @endif
            <form action="/storestaff" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="number"  name="kind" class="form-control">
                </div>
                <div class="form-group">
                ...
                <a href="allstaff" class="btn btn-success">All Staff</a>
              </form>
        </div>
    </div>
</div>
